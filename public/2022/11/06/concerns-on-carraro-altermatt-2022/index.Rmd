...
[^1]: Formally, a function $f(x)$ is said to be scale invariant if it suffices the following equation: $f(\lambda x) = \lambda^z f(x)$. A power law is one example of satisfying this equation.

where $\lambda$ is an arbitrary constant and $z$ is the scaling exponent. A power law is an example of satisfying this equation.
