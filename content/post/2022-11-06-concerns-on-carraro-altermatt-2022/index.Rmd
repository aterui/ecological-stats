...
I never thought I would do this in my life; this is certainly not something I want to do. Yet, there is no option but to write this post because otherwise, [the recent paper by Carraro and Altermatt](https://www.nature.com/articles/s43247-022-00454-1) (2022) invalidates my past research (and any research in scale invariance) and threatens my future work for unfair reasons. I posted full mathematical details as a preprint [here](https://biorxiv.org/cgi/content/short/2022.11.07.515375v1) (including the re-analysis of their data). I have no other choice but to post here because the following point was dismissed during the peer review process (I was one of the reviewers; review history [here](https://www.nature.com/articles/s43247-022-00454-1#Sec12)). I want to make clear that **I do agree (100%!) with their opinion that Optimal Channel Networks (OCNs) have very high potential to advance the ecological understanding of stream communities.** My point below is not to disregard the usefulness of OCNs by no means.
