...
They also used other key terms in a completely opposite way -- for example, the term "scaling" is used as if it describes a property of a scale-dependent object. If the use of these key terms is approved, it invalidates the entire body of literature in scale invariance since the 1960s because what we have been calling "scale-invariant" becomes "scale-dependent"...!
