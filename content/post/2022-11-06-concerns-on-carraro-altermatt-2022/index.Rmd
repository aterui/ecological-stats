...
![The length of UK coastline measured as multiple of a ruler with unit length x. As x approaches zero, the coastline length diverges to reach infinity. Image from Wikipedia Commons (CC BY-SA 4.0)](%60r%20url_gif%60){width="50%"}
